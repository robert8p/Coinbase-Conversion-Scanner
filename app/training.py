...
def _selection_score(c: Dict[str, object], selection_min_count_75: int) -> float:
    ...
    tail = (
        ...
        5.0 * pv('precision70_ok', 'precision70_ok_n', 40) +
    ...
    return tail + density_bonus - penalty - 20.0 * brier + 0.35 * auc
...
def _select_and_train_bundle(dataset: Dict[str, object], settings: Settings, model_dir: str) -> Dict[str, object]:
            ...
            for l1 in settings.enet_l1_values:
                ...
                for cal_mode in ['bucketed', 'global']:
                    ...
                    for alpha in settings.prior_alpha_values:
                        ...
                        cand['selection_score'] = _selection_score(cand, settings.selection_min_count_75)
    ...
    bundle_meta = {
        **meta_cfg,
        ...
        'selected': {k: best[k] for k in ['cw', 'C', 'l1', 'alpha', 'brier', 'auc', 'precision60_ok', 'precision70_ok', 'precision75_ok', 'precision80_ok', 'precision60_ok_n', 'precision70_ok_n', 'precision75_ok_n', 'precision80_ok_n', 'selection_score', 'cal_mode']},
